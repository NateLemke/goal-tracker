...
export default function ModalAddSubTask({closeFunc, addSubTaskFunc}) {
    ...
    const createFunc = async() => {
        await addSubTaskFunc(taskID, description, requiredProgress);
        closeFunc();
    }
    ...
    return(
        ...
        justify-center items-center absolute">
            ...
            flex-col rounded-md min-w-60 bg-gray-700">
                ...
                <label for="descInput">Subtask Description:</label>
