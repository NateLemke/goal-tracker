...
export default function ModalDeleteTask({closeFunc, deleteTaskFunc}) {

    const {goalID, taskID} = useTaskContext();
    
    const deleteFunc = () => {
        deleteTaskFunc(goalID, taskID);
        closeFunc();
    }
    ...
    return(
        ...
        justify-center items-center absolute">
            ...
            flex-col rounded-md min-w-60 bg-gray-700">
                ...
                <h2 className="text-xl mx-4">Are you sure you want to delete this Task?</h2>
